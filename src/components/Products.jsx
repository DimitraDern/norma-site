...
const productMeta = [
  { code: "01", groupKey: "mesh", img: asset("/images/product-01.jpg"), anchor: "pontarista" },
  { code: "02", groupKey: "mesh", img: asset("/images/product-02.jpg"), anchor: "panel" },
  { code: "03", groupKey: "security", img: asset("/images/product-03.png"), anchor: "akanthota" },
  { code: "04", groupKey: "mesh", img: asset("/images/product-04.png"), anchor: "pontarista" },
  { code: "05", groupKey: "constructions", img: asset("/images/product-05.png"), anchor: "kataskeves-perifraxeon" },
  { code: "06", groupKey: "equipment", img: asset("/images/product-06.png"), anchor: "xeiramaxes" },
];
...
export default function Products() {
  ...
  function onPointerUp() {
    ...
    if (dragOffset < -threshold) next();
      ...
      // setPointerCapture εμποδίζει το φυσιολογικό click event να φτάσει στο
      // εσωτερικό Link όταν δεν υπάρχει μετακίνηση -- γι' αυτό κάνουμε εδώ
      // την πλοήγηση απευθείας.
