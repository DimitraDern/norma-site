...
/*
  ...
  ΙΔΙΟ code/groupKey/images ανά κατηγορία -- έτσι το φιλτράρισμα ανά ομάδα
  δεν "σπάει" όταν αλλάζει η γλώσσα, και δείχνουν ΤΙΣ ΙΔΙΕΣ πραγματικές
  φωτογραφίες και στα δύο.
*/
...
const categoriesEn = [
  { code: "01", groupKey: "mesh", title: "Welded Wire Mesh", desc: "Electrowelded wire mesh in rolls - full range of mesh sizes, heights and wire diameters.",
    ...
    variants: [
      ...
      { name: "Welded  60×100 mm (Ø 1.80)", subtitle: "Galvanized, 25m roll", specs: [["Mesh", "60×10０ mm"], ["Wire", "Ø 1.8０ / 1.8０ mm"], ["Roll length", "25m"], ["Heights", "1.00 – 1.20 – 1.50 – 1.80 – 2.00 m"]] },
